            ...
            <div className="video-content">
              ...
              <div className="video-content__content">
                <div className="video-content__info wrapper">
                  <div className="video-content__card">
                    <div className="video-content__card-image">
                      <img
                        src={Card}
                        alt="Зоряні війни: Епізод IX -Скайвокер. Сходження "
                      />
                    </div>
                    <div className="video-content__card-actions">
                      <button className="button icon fill g8">
                        <div className="icon watch" />
                        Дивитися
                      </button>
                      <button className="button fill">Створити кімнату</button>
                    ...
                    <div className="video-content__rating">
                      <div className="rating">
                        ...
                        <div className="rating__votes">
                          ...
                          <div className="rating__votes-amount">22 голосів</div>
                        </div>
                      </div>
                    </div>
      ...
      <div className="container">
        <div className="wrapper">
          <div className="video-content__description">
            У цьому епічному завершенні саги про Скайуокера вцілілі члени Опору
            на чолі з генералом Леєю Органою (Керрі Фішер) стикаються зі своїм
            найбільшим викликом. Готуючись до фінальної сутички зі зловісним
            Першим Орденом, Рей (Дейзі Рідлі) продовжує свою подорож, щоб
            дізнатися правду про своє минуле і свій зв'язок з Силою. Разом зі
            своїми друзями Фінном (Джон Бойєга), По Деймероном (Оскар Айзек) і
            Чубаккою (Юнас Суотамо) Рей подорожує галактикою в пошуках
            відповідей, зустрічаючи на своєму шляху нових і старих ворогів. Тим
            часом зловісний Кайло Рен (Адам Драйвер) продовжує спокушати Рей
            приєднатися до нього на темній стороні, оскільки він прагне отримати
            абсолютну владу і контроль. У міру того, як битва між Опором і
            Першим Орденом загострюється, старі і нові герої повинні
            об'єднатися, щоб боротися за майбутнє галактики. Захоплюючий екшн,
            зворушливі моменти та приголомшлива розв'язка роблять "Зоряні Війни:
            Скайвокер. Сходження" обов'язковим до перегляду для шанувальників
            культової космічної опери.
          </div>
        </div>
      </div>
      <div className="container">
            ...
            <div className="reviews__container">
              <div className="review__owner">
                <div className="review__profile">
                  <img src={Avatar} alt="Qwerty" className="profile__avatar" />
              ...
              <div className="reviews__item">
                <div className="review">
                  ...
                  <div className="review__comment">
                    ...
                    що він в 7 епізоді вбив понад 155 мільярдів людей, а в цьому
                    він-шпигун руху опору. Це називається викинути персонажа на
                    смітник.
                  </div>
                  <div className="review__rating">
                    <div className="review__likes">
