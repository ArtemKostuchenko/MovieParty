...
const DirectorsAddPage = () => {
  const { addDirector, isLoadingAdd } = useDirector();
  ...
  const onSubmitHandler = async (data) => {
    const res = await addDirector({ sex, ...data });
    console.log(res);
    reset();
  ...
  return (
    <form className="person__form" onSubmit={handleSubmit(onSubmitHandler)}>
      ...
      <div className="person__form-content">
        <div className="person__form-content-title">Дані про режисера</div>
