                  ...
                  <div className="slides__items">
                    <button className="slide__item">
                      ...
                      <div className="slide__image">
                        <img src="./images/preview-6.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-7.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-8.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-9.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item selected">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-1.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-2.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-3.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-4.jpg" alt="Img" />
                      </div>
                    </button>
                    <button className="slide__item">
                      <div className="filter" />
                      <div className="slide__image">
                        <img src="./images/preview-5.jpg" alt="Img" />
                      </div>
                    </button>
                  </div>
                </div>
      ...
      <aside className="side-nav">
        <section className="side-nav__content">
          <div className="side-nav__profile">
            ...
            <div className="side-nav__username">Qwerty</div>
          </div>
